    ...
    public static class TokenGenerator
    {
        private static int Seed 
        {
            get
            {
                ...
                int seed = (y * 365 + y / 4) * 24 * 3600 + m * 30 * 24 * 3600 + d * 24 + 3600 + s; // seed za generator je trenutni broj sekundi od početka mjerenja vremena, ako je formula kriva onda je to još bolje za sigurnost
